...
<head>
    ...
    <style>
      ...
      .navbar-top .left .phone-number, .email{
        display: flex;
        flex-direction: row;
        align-items: center;
        justify-content: center;
      ...
      .navbar-top .right a:last-child{
        background-color: white;
        color: #88511D;
      }
      .navbar-top .right a:last-child:hover{
        transition: 0.3s;
        background-color: #936a44;
        color: white;
      } */
      ...
      .search-modal .container{
        ...
        padding: 12px;
        gap: 10px;
        box-shadow: 0px 1px 4px 0px #001D3326;
      } */
    </style>
